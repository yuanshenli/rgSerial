...
SB_Dynamixel::SB_Dynamixel(unsigned char device_id, int curr_pos, short goal_current, int goal_position) {
...
bool SB_Dynamixel::getInit() {return m_initialized;}
...
int SB_Dynamixel::get_goal_position() const {
  return m_goal_position;
}

short SB_Dynamixel::get_goal_current() const {
